function RowTable({rowsData, deleteRowTable, handleChange}) {
        ...
        rowsData.map((data, index)=>{
            ...
            return(
               ...
               <input type="number" value={slno} onChange={(evnt)=>(handleChange(index, evnt))} name="slno" className="form-control"/>
                ...
                <td><button className="btn btn-outline-danger" onClick={()=>(deleteRowTable(index))}>delete this row</button></td>
            </tr>
